...
int main() {
	...
	//name = new char[strlen("Iany") + 1]; 
	// //memory leak here if we don't use delete. always clear the memory before allocating new memory.
	name = func_2(name);
...
char* func_2(char* name) {
	...
	//name = new char[strlen("Iany") + 1]; 
	// //this doesn't work, same as before, using new inside the function will override the saved address;
